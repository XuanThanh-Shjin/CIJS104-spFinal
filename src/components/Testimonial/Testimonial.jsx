...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 mx-4 transition-all duration-200 rounded-lg shadow hover:shadow-lg w-72 shrink-0">
            <div className="flex gap-2">
                <img className="rounded-full size-11" src={card.image} alt="User Image" />
            ...
            <p className="py-4 text-sm text-gray-800">I've used many booking platforms before, but none compare to the personalized experience and attention to detail.</p>
            <div className="flex items-center justify-between text-xs text-slate-500">
                <div className="flex items-center gap-1">
                    <span>Posted on</span>
                    <a href="" target="_blank" className="hover:text-sky-500">
  ...
  return (
    <>
        ...
        `}</style>
        <div className='flex flex-col items-center px-6 pt-20 pb-30 md:px-16 lg:px-24 '>
